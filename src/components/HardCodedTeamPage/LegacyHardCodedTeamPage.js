												...
												<Fade duration={500} clear when={this.state.expanded[i] === true}>
													<div style={{
														...
														<div style={{
															...
															{d.GITHUB &&
																<a href={d.GITHUB} rel="noopener noreferrer" target="_blank" className="icon">
																	<FontAwesomeIcon icon={faGithub} size={"2x"} />
																</a>}
															{d.LINKEDIN &&
																<a href={d.LINKEDIN} rel="noopener noreferrer" target="_blank" className="icon">
																	<FontAwesomeIcon icon={faLinkedin} size={"2x"} />
																</a>}
															{d.WEBSITE &&
																<a href={d.WEBSITE} rel="noopener noreferrer" target="_blank" className="icon">
